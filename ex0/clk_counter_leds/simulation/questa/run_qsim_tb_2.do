# QuestaSim simulation script for clk_counter_leds_top_tb_2.sv testbench
...
set TESTBENCH_FILE clk_counter_leds_top_tb_2.sv
set TESTBENCH_MODULE clk_counter_leds_top_tb_2
...
# Checks if the 'work' and 'rtl_work' libraries already exist, deletes the existing libraries to avoid conflicts. 
if {[file exists work]} {
	vdel -lib work -all
}
